...
class AudioPlayerBase {
  ...
  static Future<void> init({
    ...
    ApbIYtExplodeProvider? ytExplodeProvider,
  }) async {
    ...
    if (ytExplodeProvider != null) {
      GetIt.I.registerLazySingleton<ApbYtExplodeProvider>(() => ApbYtExplodeProvider(ytExplodeProvider));
    }
